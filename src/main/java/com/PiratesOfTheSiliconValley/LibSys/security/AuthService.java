...
import com.PiratesOfTheSiliconValley.LibSys.views.staff.StaffUserView;
...
public class AuthService {
    ...
    public List<AuthorizedRoute> getAuthorizedRoutes(Role role) {
        ...
        if (role.equals(Role.USER)) {
            routes.add(new AuthorizedRoute("loggedinmain", "LoggedInMain", LoggedInMain.class));
            routes.add(new AuthorizedRoute("useraccount", "Useraccount", UserAccount.class));
            routes.add(new AuthorizedRoute("logout", "Logout", LogoutView.class));
        } else if (role.equals(Role.ADMIN)) {
            routes.add(new AuthorizedRoute("loggedinmain", "LoggedInMain", LoggedInMain.class));
            routes.add(new AuthorizedRoute("staffbook", "Staffbook", StaffBookView.class));
            routes.add(new AuthorizedRoute("staffuser", "Staffuser", StaffUserView.class));
            routes.add(new AuthorizedRoute("logout", "Logout", LogoutView.class));
        }
        return routes;
    }
